...
public class FileCommandProvider implements controller.commandHandler.CommandProvider {
    ...
    public void registerCommands (controller.commandHandler.CommandRegistry registry){
        ...
        // other commands
        registry.register("menu enter (?<menu_name>\\w*)" ,
                new menu_enter(this.menuManager));
        registry.register("menu show current" ,
                new menu_show_current());
        registry.register("menu exit" ,
                new menu_exit());
        registry.register("^register -u (?<username>[A-Za-z0-9-]+) -p (?<password>\\S+) (?<password_confirm>\\S+) -n (?<nickname>\\S+) -e (?<email>\\S+) -g (?<gender>\\w+)$" ,
                new new_user());
        registry.register("pick question -q (?<question_number>\\d+) -a (?<answer>\\S+) -c (?<answer_confirm>\\S+)" ,
                new pick_a_question());
        registry.register("login -u (?<username>[A-Za-z0-9-]) -p (?<password>\\S+) -stay-logged-in" ,
                new login(this.menuManager));
        registry.register("forget password -u (?<username>[A-Za-z0-9-] -e (?<email>\\S+)" ,
                new forget_password(this.menuManager));
        registry.register("answer -a (?<answer>\\S+)" ,
                new answer(this.menuManager));
        registry.register("new password -p (?<username>\\S+)",
                new SetNewPassword(this.menuManager));
        registry.register("menu logout" ,
                new logout());
        registry.register("menu enter chapter -c (?<chaptername>\\S+)" ,
                new enter_Chapter());
        registry.register("menu greenhouse" ,
                new enter_greenHouse());
        ...
        registry.register("menu news show-unread" ,
                new show_unreadNews());
        registry.register("menu news show-all" ,
                new show_allNews());
        registry.register("menu profile change-username -u (?<username>\\S+)" ,
                new change_username(this.menuManager));
        registry.register("menu profile change-nickname -u (?<nickname>\\S+)" , new change_nickName(this.menuManager));
        registry.register("menu profile change-email -e (?<email>\\S+)" , new change_email(this.menuManager));
        registry.register("menu profile change-password -p (?<new_password>\\S+) -o (?<old_password>\\S+)" ,
                new change_password(this.menuManager));
        registry.register("menu profile show-info" , new showInfo(this.menuManager));
        registry.register("menu collection show-(?<all/nothing>\\S+)plants" ,
                new showPlantsCollection(this.menuManager));
        registry.register("menu collection show-(?<all/nothing>)zombies" ,
                new showZombiesCollection(this.menuManager));
        registry.register("menu collection show-plant -p (?<plant_name>\\S+)" ,
                new show_plant_details(this.menuManager));
        registry.register("menu collection show-zombie -z (?<zombie_name>\\S+)" ,
                new show_zombie_details(this.menuManager));
        registry.register("menu collection upgrade-plant -p (?<plant_name>\\S+)" ,
                new upgradePlant(this.menuManager));
        registry.register("menu collection purchase-plant -p (?<plant_name>\\S+)" ,
                new purchasePlant(this.menuManager));
        registry.register("show (?<all/available>) plants" , new show_plantsList(this.menuManager));
        registry.register("add plant -t (?<type>\\S+)" , new addPlant(this.menuManager));
        registry.register("remove plant -t (?<type>\\S+)" , new removePlant(this.menuManager));
        registry.register("boost plant -t (?<type>\\S+)" , new boostPlant(this.menuManager));
        ...
        registry.register("show greenhouse" , new show_greenHouse(this.menuManager));
        registry.register("plant pot at ((?<x>\\d+), (?<y>\\d+))" , new plant_pot(this.menuManager));
        registry.register("collect ((?<x>\\d+), (?<y>\\d+))" , new collect_command(this.menuManager));
        registry.register("grow ((?<x>\\d+), (?<y>\\d+))" , new faster_grow(this.menuManager));
        registry.register("enter shop" , new enter_shop());
        registry.register("shop (?<list/daily>\\S+)" , new show_products_commands(this.menuManager));
        registry.register("shop buy -i (?<item_id>\\S+) -n (?<count>\\d+) [-t (?<plant_type>\\S+)]" , new buy_command(this.menuManager));
