...
import com.workshop.model.TimeManager;
...
public class SunManager {
    ...
    public void generateRandom() {
        ...
        com.workshop.view.Console.showMessage("New " + type + " sun is dropping at position (" + x + ", " + y + ")");
    }
    ...
    public int stealSun(Sun sun) {
        ...
        Console.showMessage("Ra stealed a sun at " + sun.getX() + ", " + sun.getY());
        return amount;
    }
