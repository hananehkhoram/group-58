...
public class PamActor extends Table {
    ...
    public void setClip(String clip) {
        ...
        currentDuration = pvz.browser.core.BrowserContext.player.clipDurationSeconds(pam, currentClip);
        resetTime();
    }
