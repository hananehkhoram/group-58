...
public final class IceMissileLayer extends Group {
    ...
    private final class MissileActor extends Actor {
        ...
        private void drawFallbackSprite(Batch batch, float parentAlpha, float y) {
            ...
            batch.setColor(0.35f, 0.8f, 1f, parentAlpha);
        ...
        private void drawPam(
            ...
            batch.setColor(red, green, blue, parentAlpha);
            try {
    ...
    private static String bindPam(PamPlayer player, String[] paths) {
        for (String path : paths) {
            ...
            try {
                ...
                Gdx.app.error("IceMissileLayer", "Could not load " + path, exception);
            }
        }
        return null;
    }
