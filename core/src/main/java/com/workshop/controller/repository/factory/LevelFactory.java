...
import com.workshop.model.season.*;
...
public class LevelFactory {
    ...
    public static List<Level> buildIzombieLevels() {
        ...
        levels.add(new Level("Izombie - Day 1", 5, 9, generateWaves(0, 200, 0), LevelType.Izambie_MG, null));

        levels.add(new Level("Izombie - Day 2", 5, 9, generateWaves(0, 220, 0), LevelType.Izambie_MG, null));

        levels.add(new Level("Izombie - Day 3", 5, 9, generateWaves(0, 240, 0), LevelType.Izambie_MG, null));
