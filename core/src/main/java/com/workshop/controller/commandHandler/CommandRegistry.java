...
public class CommandRegistry {
    private static class CommandEntry{
        Pattern pattern;
        com.workshop.controller.commandHandler.Command command;

        CommandEntry(String regex, com.workshop.controller.commandHandler.Command command){
    ...
    public void register(String regex, com.workshop.controller.commandHandler.Command command){
